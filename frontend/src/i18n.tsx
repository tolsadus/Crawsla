...
const en = {
  ...
  auctions_starting: "Starting bid",
  auctions_tba: "TBA",
  auctions_soh: "SoH",
  ...
  unhide_listing: "Unhide listing",
  hidden_show_count: "Show {n} hidden",
  hidden_hide_count: "Hide {n} hidden",
  vote_alive: "Still online",
  vote_offline: "Offline",
  vote_signin: "Sign in to vote",
  vote_flagged: "Flagged offline by community",
  // Dropped
  ...
  dropped_signin_prompt: "Sign in to unlock the top deals",
  dropped_signin_btn: "Sign in",
...
const fr: Record<TKey, string> = {
  ...
  auctions_starting: "Mise à prix",
  auctions_tba: "À venir",
  auctions_soh: "SoH",
  ...
  hide_listing: "Masquer l'annonce",
  unhide_listing: "Réafficher l'annonce",
  hidden_show_count: "Afficher {n} masquée(s)",
  hidden_hide_count: "Cacher {n} masquée(s)",
  vote_alive: "Toujours en ligne",
  vote_offline: "Hors ligne",
  vote_signin: "Connectez-vous pour voter",
  vote_flagged: "Signalée hors ligne par la communauté",
  // Dropped
  ...
  dropped_signin_prompt: "Connectez-vous pour voir les meilleures affaires",
  dropped_signin_btn: "Se connecter",
